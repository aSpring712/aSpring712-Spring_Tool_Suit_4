...
$("#btnModify").click(function() {
	data = { // submit해도 되지만 json 형태로 넘기기
		"num" : $("#num").val(),
		"title" : $("#title").val(),
		"content" : $("#content").val()
	} // 3개의 값을 가지고
	$.ajax({
		...
		url:"/myapp06/update", // update에 put 방식으로 전달
		...
		success:function(resp) {
			if(resp=="success") {
				alert("수정완료") // 수정 완료 후
				/* location.href="/myapp06/view/${board.num}"; -> 다시 상세보기로 이동 */
				location.href="/myapp06/list"; // 전체보기로 이동
			}
		} // success
	}) // ajax
}) // btnDelete
